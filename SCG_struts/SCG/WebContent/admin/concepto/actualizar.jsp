			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Actualizar Concepto</strong></li>
					</ol>
				</div>
						...
						<div class="ibox float-e-margins">
							...
							<div class="ibox-content">
								<form class="form-horizontal m-t-md" action="#">
									<input id="txt_idconcepto" type="hidden" value="<s:property value='idconcepto'/>">
								
									<div class="form-group">
										<div class="col-sm-12">
											<label class="col-sm-2">Nombre</label>
											<div class="col-sm-10">
												<input id="txt_nombre" class="form-control" value="<s:property value='nombre'/>">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<div class="col-sm-10">
												<input id="txt_descripcion" class="form-control" value="<s:property value='descripcion'/>">
											</div>
										</div>
									</div>
	...
	<script>
		$(document).ready(function() {
			$("#btn_grabar").click(function(){
				...
				$.ajax({
				   url:'ajax_concepto_actualizar',
				   method:'POST',
				   data:{
					   	'codigo':'ACTUALIZAR',
					   	'idconcepto':$('#txt_idconcepto').val(),
