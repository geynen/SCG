	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				...
				<h2>
				<s:a action="UsuarioNuevo" class="btn btn-primary">Nuevo</s:a>
				</h2>
				</div>
			</div>
		...
		$(document).ready(function() {
			...
			function eventos(){
				$(".btn_editar").click(function(){
					console.log('UsuarioActualizar?idusuario='+$(this).data('id'));
					window.open('UsuarioActualizar?idusuario='+$(this).data('id'),'_self');
				});
				$(".btn_eliminar").click(function(){
					if(confirm('Esta seguro que desea eliminar el usuario?')){
						$.ajax({
						   url:'ajax_usuario_eliminar',
						   method:'POST',
						   data:{
							   	'codigo':'ELIMINAR',
