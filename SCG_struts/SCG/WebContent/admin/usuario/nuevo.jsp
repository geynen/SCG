			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Registrar Usuario</strong></li>
					</ol>
				</div>
								...
								<form class="form-horizontal m-t-md" action="#">
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<div class="col-sm-10">
												<input id="txt_nombres" class="form-control" maxlength="45">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<div class="col-sm-10">
												<input id="txt_apellidos" class="form-control" maxlength="45">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<div class="col-sm-10">
												<input id="txt_dni" class="form-control" maxlength="8">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<div class="col-sm-10">
												<input id="txt_email" class="form-control" maxlength="50">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<div class="col-sm-10">
												<input id="txt_login" class="form-control" maxlength="45">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											...
											<div class="col-sm-10">
												<input type="password" id="txt_clave" class="form-control" maxlength="45">
											</div>
										</div>
									</div>
