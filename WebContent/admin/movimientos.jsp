	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
				...
				<li class="active"><a href="movimientos.jsp"><i
						class="fa fa-bar-chart-o"></i> <span class="nav-label">Reg.
				...
				<li><a href="gastos.jsp"><i class="fa fa-credit-card"></i>
						<span class="nav-label">Gastos</span></a></li>
			</ul>
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Registrar Movimientos</strong></li>
					</ol>
				</div>
					...
					<div class="col-lg-12" id="contenedor_respuesta">
						...
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5>Formulario Registrar Movimientos</h5>
								...
								<form class="form-horizontal m-t-md" action="#">
									...
									<div class="form-group">
										<div class="col-sm-6">
											...
											<div class="col-sm-9">
												<!-- 
												<select id="cbo_tipo" data-placeholder="Escoga Tipo Ingreso"
												 ...
												 -->
												<%= GestionaUsuario.getComboParametros(4, "cbo_tipo", "Escoga Tipo Ingreso")%>
											</div>
										</div>
										<div class="col-sm-6">
